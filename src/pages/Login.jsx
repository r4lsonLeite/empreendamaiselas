...
// Importe a imagem que você salvou (ajuste o caminho se necessário)
import loginBg from '../assets/login-bg.png';

export default function Login() {
  return (
    <div className="flex min-h-screen bg-surface-container-lowest font-body-md">
      
      {/* LADO ESQUERDO - IMAGEM (Ocupa 50% da tela no desktop, some no celular) */}
      <div className="hidden md:flex md:w-1/2 relative bg-[#f4f1ed]">
        {/* object-top garante que o topo da imagem (onde está o texto/logo) nunca seja cortado */}
        <img 
          src={loginBg} 
          alt="Mulheres empreendedoras colaborando" 
          className="absolute inset-0 w-full h-full object-cover object-top"
        />
      </div>

      {/* LADO DIREITO - FORMULÁRIO */}
      <div className="flex-1 flex flex-col justify-between px-6 py-8 md:px-16 lg:px-24">
        
        {/* Espaçador invisível para empurrar o form para o meio verticalmente */}
        <div className="hidden md:block pt-8"></div>
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="mb-stack-lg text-center md:text-left">
            <h1 className="font-headline-lg-mobile md:font-headline-lg text-3xl font-bold text-on-surface mb-base">
              Bem-vinda de volta
            </h1>
          ...
          <div className="flex border-b border-outline-variant/30 mb-stack-md">
            <button className="flex-1 pb-base text-primary border-b-2 border-primary font-label-md font-bold transition-colors">
              Entrar
            </button>
        ...
        {/* Mini Footer na direita (conforme o Figma) */}
        <footer className="mt-12 flex flex-col md:flex-row justify-between items-center text-center md:text-left text-xs text-on-surface-variant gap-2 opacity-70">
          <div className="flex gap-4">
            <a href="#" className="hover:text-primary transition-colors">Empreenda Mais Elas</a>
            <a href="#" className="hover:text-primary transition-colors">About Us</a>
            <a href="#" className="hover:text-primary transition-colors">Privacy</a>
          </div>
          <p>© 2026 Empreenda Mais Elas.</p>
        </footer>
